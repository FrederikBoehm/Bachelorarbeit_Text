...
Since \acs{BERT} has a maximum text length it can process, it was interesting how long some of the resulting sentences were. % Try to formulate sentence without mentioning BERT
